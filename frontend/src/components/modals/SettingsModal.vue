              ...
              <div class="space-y-6">
                ...
                <div class="flex items-start justify-between bg-slate-950/80 p-3 rounded-xl border border-slate-800 space-x-3">
                  <div class="space-y-0.5">
                    ...
                    <p class="text-[11px] text-slate-400">Фізично масштабує надвеликі зображення (наприклад, 4000px фото) під максимальний розмір контейнера на сайті з запасом Retina 2x. Усуває попередження Lighthouse «Properly size images».</p>
                  </div>
